...
import styles from './TeacherActivitiesDetailPage.module.scss';
...
function ActivitiesDetailPage() {
      ...
      setPageActions([
        {
          ...
          onClick: () => navigate(buildPath.teacherActivityEdit(id)),
        },
      ]);
    }
  ...
  }, [activity, id, navigate, setBreadcrumbs, setPageActions]);
