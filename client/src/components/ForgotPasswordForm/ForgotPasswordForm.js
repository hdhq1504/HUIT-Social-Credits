        ...
        return (
          <>
            ...
            <p className={cx('otp-message')}>
              Mã xác thực được gửi qua Email <span style={{ color: 'var(--primary)' }}>{email}</span> của bạn. Vui lòng kiểm tra
              hộp thư.
            </p>
            <div className={cx('input-gr')}>
            ...
            <div className={cx('input-gr')}>
              ...
              <div className={cx('input-password')}>
                <div className={cx('password-field-container')}>
                  ...
                  />
                  <button type="button" className={cx('toggle-password')} onClick={togglePasswordVisibility}>
                    {password.length > 0 && (
                      <FontAwesomeIcon
