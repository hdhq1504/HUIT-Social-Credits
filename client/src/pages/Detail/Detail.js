          ...
          <Modal open={openModal} onClose={handleCloseModal}>
            <Box className={cx('modal-content')}>
              ...
              <Box className={cx('modal-carousel')}>
                <IconButton onClick={handlePrevImage} className={cx('carousel-arrow')} style={{ color: 'white' }}>
                  <ChevronLeftIcon />
                </IconButton>
                ...
                <IconButton onClick={handleNextImage} className={cx('carousel-arrow')} style={{ color: 'white' }}>
                  <ChevronRightIcon />
                </IconButton>
              </Box>
                ...
                <div key={index} className={cx('chat-message')}>
                  ...
                  <div className={cx('message-content')}>
                    ...
                    <p className={cx('message-actions')}>
                      <Button size="small" startIcon={<ThumbUpIcon />} className={cx('action-btn')}>
                        Thích ({msg.likes})
                      </Button>
