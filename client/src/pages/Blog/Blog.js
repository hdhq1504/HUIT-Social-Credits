...
const newsData = [
  ...
  },
  {
    ...
    description: 'Mẹo quản lý và sắp xếp tài liệu hiệu quả giúp bạn tiết kiệm thời gian và nâng cao hiệu suất học tập.',
            ...
            {knowledgeSharingNews.length > 0 && (
              <div className={cx('main-news-item')}>
                ...
                <div className={cx('main-info')}>
                  <p className={cx('date')}>
                    <span>🕒</span> {knowledgeSharingNews[0].date} • 📈 {knowledgeSharingNews[0].views}
                  </p>
                  <h2 className={cx('main-title')}>
                    <Link to={`/news/${knowledgeSharingNews[0].id}`}>{knowledgeSharingNews[0].title}</Link>
                  </h2>
              ...
              {knowledgeSharingNews.length > 0 && (
                <>
                  <div className={cx('main-news-item')}>
                    ...
                    <div className={cx('main-info')}>
                      <p className={cx('date')}>
                        <span>🕒</span> {knowledgeSharingNews[1].date} • 📈 {knowledgeSharingNews[1].views}
                      </p>
                      <h2 className={cx('main-title')}>
                        <Link to={`/news/${knowledgeSharingNews[1].id}`}>{knowledgeSharingNews[1].title}</Link>
                      </h2>
              ...
              {studyExperienceNews.length > 0 && (
                <>
                  <div className={cx('main-news-item')}>
                    ...
                    <div className={cx('main-info')}>
                      <p className={cx('date')}>
                        <span>🕒</span> {studyExperienceNews[2].date} • 📈 {studyExperienceNews[2].views}
                      </p>
                      <h2 className={cx('main-title')}>
                        <Link to={`/news/${studyExperienceNews[2].id}`}>{studyExperienceNews[2].title}</Link>
                      </h2>
